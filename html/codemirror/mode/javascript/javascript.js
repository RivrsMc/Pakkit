...
import lib from "../../lib/codemirror";

(function (mod) {
  if (typeof exports === 'object' && typeof module === 'object') // CommonJS
  { mod(lib) } else if (typeof define === 'function' && define.amd) // AMD
  ...
  CodeMirror.defineMode('javascript', function (config, parserConfig) {
    ...
    const keywords = (function () {
      ...
      const A = kw('keyword a'); const B = kw('keyword b'); const C = kw('keyword c'); const D = kw('keyword d')
    ...
    function classfield (type, value) {
      ...
      if (value == '=') return cont(expressionNoComma)
      const context = cx.state.lexical.prev; const isInterface = context && context.info == 'interface'
